...
var dt = 0,
    ...
    ee = 6,
    n0 = 7,
    b0 = [new O0(dt, 0, !1), new O0(Be, 0, !0), new O0(_0, 1, !1), new O0(T0, 1, !0), new O0(le, 2, !1), new O0(d0, 2, !0), new O0(ee, 3, !1), new O0(n0, 3, !0)],
    Ma = [le, d0, le, d0, ee, n0, ee, n0],
    za = [d0, d0, d0, d0, n0, n0, n0, n0],
    Aa = [_0, T0, le, d0, ee, n0, ee, n0],
    Ta = [T0, T0, d0, d0, n0, n0, n0, n0],
    Ba = [Be, Be, T0, T0, d0, d0, n0, n0],
...
function ft(r, e, t) {
    if (!y0[e]) throw new Error("Font metrics not found for font: " + e + ".");
    var a = r.charCodeAt(0),
        n = y0[e][a];
    if (!n && r[0] in Ot && (a = Ot[r[0]].charCodeAt(0), n = y0[e][a]), !n && t === "text" && vr(a) && (n = y0[e][77]), n) return {
        depth: n[0],
        height: n[1],
        italic: n[2],
        skew: n[3],
...
var nt = {
    ...
    xr = function(e) {
        ...
        for (var s in this.attributes) this.attributes.hasOwnProperty(s) && (t += " " + s + '="' + I.escape(this.attributes[s]) + '"');
        t += ">";
...
class Xa {
    ...
    toMarkup() {
        var e = "<img  src='" + this.src + " 'alt='" + this.alt + "' ",
            t = "";
        for (var a in this.style) this.style.hasOwnProperty(a) && (t += I.hyphenate(a) + ":" + this.style[a] + ";");
...
var xe = [
    ...
    g0 = function(e, t, a, n, s) {
        ...
        } else typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'")), c = new f0(e, 0, 0, 0, 0, 0, s);
        if (n) {
    ...
    _a = function(e, t, a) {
        var n = e.mode,
            ...
            p = "",
            g = "";
        if (s.charCodeAt(0) === 55349 && ([p, g] = Ka(s, n)), p.length > 0) return g0(s, p, n, t, o.concat(g));
        if (c) {
            var y, w;
            if (c === "boldsymbol") {
                var x = Qa(s, n, t, o, a);
                y = x.fontName, w = [x.fontClass]
            } else h ? (y = Mr[c].fontName, w = [c]) : (y = we(c, t.fontWeight, t.fontShape), w = [c, t.fontWeight, t.fontShape]);
            if (Ee(s, y, n).metrics) return g0(s, y, n, t, o.concat(w));
            if (wr.hasOwnProperty(s) && y.slice(0, 10) === "Typewriter") {
                for (var z = [], T = 0; T < s.length; T++) z.push(g0(s[T], y, n, t, o.concat(w)));
                return Sr(z)
            }
        }
        if (a === "mathord") return g0(s, "Math-Italic", n, t, o.concat(["mathnormal"]));
        if (a === "textord") {
            var C = $[n][s] && $[n][s].font;
            if (C === "ams") {
...
class c0 {
    ...
    toMarkup() {
        var e = "<" + this.type;
        for (var t in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, t) && (e += " " + t + '="', e += I.escape(this.attributes[t]), e += '"');
...
var S = {
    ...
    bt = function(e, t) {
        ...
        var s = e.text;
        if (I.contains(["\\imath", "\\jmath"], s)) return null;
        ...
        function a() {
            ...
            if (I.contains(["widehat", "widecheck", "widetilde", "utilde"], c)) {
                var p = e,
                    g = k1(p.base),
                    y, w, x;
                if (g > 5) c === "widehat" || c === "widecheck" ? (y = 420, h = 2364, x = .42, w = c + "4") : (y = 312, h = 2340, x = .34, w = "tilde4");
                else {
                    var z = [1, 1, 2, 2, 3, 3][g];
                    c === "widehat" || c === "widecheck" ? (h = [0, 1062, 2364, 2364, 2364][z], y = [0, 239, 300, 360, 420][z], x = [0, .24, .3, .3, .36, .42][z], w = c + z) : (h = [0, 600, 1033, 2339, 2340][z], y = [0, 260, 286, 306, 312][z], x = [0, .26, .286, .3, .306, .34][z], w = "tilde" + z)
                }
                var T = new P0(w),
                    C = new D0([T], {
                        width: "100%",
...
var xt = (r, e) => {
        ...
        var g = a.label === "\\c",
            ...
            w;
        if (a.isStretchy) w = N0.svgSpan(a, e), w = b.makeVList({
    ...
    Nr = (r, e) => {
        var t = r.isStretchy ? N0.mathMLnode(r.label) : new S.MathNode("mo", [p0(r.label, r.mode)]),
...
var ne = function(e, t, a) {
    ...
    Ze = function(e, t, a) {
        var n = y0["Size4-Regular"][e.charCodeAt(0)] ? y0["Size4-Regular"][e.charCodeAt(0)][4] : y0["Size1-Regular"][e.charCodeAt(0)][4],
    ...
    H1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱"],
...
function He(r, e) {
    var t = Ie(r);
    if (t && I.contains(U1, t.text)) return t;
...
B({
    ...
    htmlBuilder: (r, e) => {
        Kt(r);
        for (var t = t0(r.body, e, !0, ["mopen", "mclose"]), a = 0, n = 0, s = !1, o = 0; o < t.length; o++) t[o].isMiddle ? s = !0 : (a = Math.max(t[o].height, a), n = Math.max(t[o].depth, n));
...
var kt = (r, e) => {
        var t = b.wrapFragment(P(r.body, e), e),
            ...
            n = e.sizeMultiplier,
            s, o = 0,
            h = I.isCharacterBox(r.body);
        if (a === "sout") s = b.makeSpan(["stretchy", "sout"]), s.height = e.fontMetrics().defaultRuleThickness / n, o = -.5 * e.fontMetrics().xHeight;
        else if (a === "phase") {
            var c = K({
                    number: .6,
                    unit: "pt"
...
var k0 = function(e, t) {
        ...
        function V(pe) {
            for (var ve = 0; ve < pe.length; ++ve) ve > 0 && (H += .25), p.push({
                pos: H,
                isDashed: pe[ve]
            })
        }
        ...
        for (n = 0, R0 = 0; n < h || R0 < U0.length; ++n, ++R0) {
...
var Jr = (r, e) => {
    ...
    At = (r, e) => {
        ...
        if (g) {
            ...
            x - o.depth - (O + .5 * y) < z && (x += z - (x - o.depth - (O + .5 * y))), O - .5 * y - (p.height - T) < z && (T += z - (O - .5 * y - (p.height - T)));
            var H = -(O - .5 * y);
            C = b.makeVList({
                positionType: "individualShift",
                children: [{
            ...
            N < z && (x += .5 * (z - N), T += .5 * (z - N)), C = b.makeVList({
                positionType: "individualShift",
                children: [{
                    type: "elem",
                    elem: p,
...
var _r = (r, e, t, a, n, s, o) => {
    ...
    ce = (r, e) => {
        var t;
        if (r.symbol) t = new c0("mo", [p0(r.name, r.mode)]), I.contains(ea, r.name) && t.setAttribute("largeop", "false");
    ...
    j1 = (r, e) => {
        for (var t = o0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
            ...
            if (!(s instanceof S.SpaceNode))
                if (s instanceof S.MathNode) switch (s.type) {
                    case "mi":
                    case "mn":
                    case "ms":
                    case "mspace":
...
var K1 = function(e, t) {
    ...
    if (a)
        if (a.type === "op") {
            ...
            if (a.type === "accent") return I.isCharacterBox(a.base) ? xt : null;
...
$0({
    ...
    htmlBuilder(r, e) {
        ...
        var V;
        if (h && c) {
            g = Math.max(g, T, h.depth + .25 * p.xHeight), y = Math.max(y, p.sub2);
        ...
        } else if (h) g = Math.max(g, T, h.depth + .25 * p.xHeight), V = b.makeVList({
            positionType: "shift",
            positionData: -g,
            children: [{
                type: "elem",
...
$0({
    ...
    mathmlBuilder(r, e) {
        var t = new S.MathNode("mi", [p0(r.text, r.mode, e)]),
            a = bt(r, e) || "italic";
...
?)[ \r	]*`,
    mt = "[̀-ͯ]",
    r4 = new RegExp(mt + "+$"),
    a4 = "(" + na + "+)|" + (t4 + "|") + "([!-\\[\\]-‧‪-퟿豈-￿]" + (mt + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (mt + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + e4) + ("|" + _1 + ")");
class hr {
    constructor(e, t) {
    ...
    lex() {
        ...
        if (t === e.length) return new x0("EOF", new u0(this, t, t));
        var a = this.tokenRegex.exec(e);
        if (a === null || a.index !== t) throw new M("Unexpected character: '" + e[t] + "'", new x0(e[t], new u0(this, t, t + 1)));
        var n = a[6] || a[3] || (a[2] ? "\\ " : " ");
...
m("\\char", function(r) {
    ...
    if (t) {
        ...
        for (var n;
             (n = mr[r.future().text]) != null && n < t;) a *= t, a += n, r.popToken()
    }
    return "\\@char{" + a + "}"
});
var Bt = (r, e, t) => {
...
var ia = A(y0["Main-Regular"][84][1] - .7 * y0["Main-Regular"][65][1]);
...
class ue {
    ...
    parseExpression(e, t) {
        for (var a = [];;) {
            ...
            var n = this.fetch();
            if (ue.endOfExpression.indexOf(n.text) !== -1 || t && n.text === t || e && F0[n.text] && F0[n.text].infix) break;
    ...
    parseStringGroup(e, t) {
        ...
        for (var n = "", s;
             (s = this.fetch()).text !== "EOF";) n += s.text, this.consume();
        return this.consume(), a.text = n, a
    }
    parseRegexGroup(e, t) {
        for (var a = this.fetch(), n = a, s = "", o;
             (o = this.fetch()).text !== "EOF" && e.test(s + o.text);) n = o, s += n.text, this.consume();
